...
// Element
$contact_title = get_field('house_contact_title');
$project_logo = get_field('house_contact_logo');
$contact_address = get_field('house_contact_address');
$contact_tel = get_field('house_contact_tel');
$sale_map_url = get_field('house_contact_sale_gallery');
$site_map_url = get_field('house_contact_project_site');
$line_at = get_field('house_contact_line_at');
$facebook = get_field('house_contact_facebook');
$map_image = get_field('house_contact_image_map');
if(get_field('contact_tel') !== '') {
	$tel = get_field('contact_tel');
} else {
  $tel =$form_group['house_form_tel'];
}
					...
					<div class="row">
						<div class="col-xs-12 col-sm-6 contact-side contact-right-side add-border-right">
							<div class="contact-info">
								<img class="contact-logo" src="<?php echo $project_logo; ?>" alt="">
								<p><?php echo $contact_address; ?></p>
                <?php if($tel) : ?>
								<a href="tel:<?php echo $tel; ?>" class="telbox">
									<i class="fa fa-phone" aria-hidden="true"></i> <?php echo $tel; ?>
								</a>
                <?php endif; ?>
                      ...
                      <svg fill="#ffffff" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 264 512" style="width: 10px;margin-right: 3px;height: 16px;margin-bottom: -2px;"><path d="M76.7 512V283H0v-91h76.7v-71.7C76.7 42.4 124.3 0 193.8 0c33.3 0 61.9 2.5 70.2 3.6V85h-48.2c-37.8 0-45.1 18-45.1 44.3V192H256l-11.7 91h-73.6v229"/></svg> <?php echo __('Facebook', 'Projects template texts'); ?>
						...
						<div class="col-xs-12 col-sm-6 contact-side">
							...
							<div id="showmap">
								<a class="map-container" data-lity href="<?php echo $map_image['url']; ?>">
