...
$header_styles = get_field('progress_header_styles');
$header_color = $header_styles['title_color'];

$section_styles = get_field('progress_section_styles');
					...
					<div class="gallery-progress">
						...
						<div class="col-lg-5 col-md-5 col-sm-5 gallery-content f-right">
							...
							<div class="col-xs-12 nopadding text-center">
								<h5 class="month">ความคืบหน้าเดือน<?php echo $month_progress; ?></h5>
							</div>
							<?php
							if($desc_rows) {
